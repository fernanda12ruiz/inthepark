...
angular.module('esqueleto')
    .controller('pageidController', function ($scope, $rootScope, $routeParams, $route, $firebaseObject, $firebaseArray, $sanitize, $http, $sce, MetadataService) {
    'use strict';
    ...
    $scope.theproject = $firebaseObject(ref.child('Portfolio/page/'+$scope.id));

    
    $scope.Addoniess = $firebaseArray(ref.child('Portfolio/page/' + $scope.id + '/Addon'));
