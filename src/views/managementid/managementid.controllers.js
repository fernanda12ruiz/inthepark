...
angular.module('esqueleto')
    .controller('managementidController', function ($scope, $rootScope, $routeParams, $route, $firebaseObject, $firebaseArray, $sanitize, $http, $sce, MetadataService) {
    'use strict';
    ...
    $scope.theproject = $firebaseObject(ref.child('Portfolio/management/'+$scope.id));

    
    $scope.Addoniess = $firebaseArray(ref.child('Portfolio/management/' + $scope.id + '/Addon'));
