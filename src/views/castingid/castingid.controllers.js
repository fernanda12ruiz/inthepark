...
angular.module('esqueleto')
    .controller('castingidController', function ($scope, $rootScope, $routeParams, $route, $firebaseObject, $firebaseArray, $sanitize, $http, $sce, MetadataService) {
    'use strict';
    ...
    $scope.theproject = $firebaseObject(ref.child('Portfolio/casting/'+$scope.id));

    
    $scope.Addoniess = $firebaseArray(ref.child('Portfolio/casting/' + $scope.id + '/Addon'));
